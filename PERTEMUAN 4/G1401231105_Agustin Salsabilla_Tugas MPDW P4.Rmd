---
title: "G1401231105_Agustin Salsabilla_Tugas MPDW P4"
...
Akan dicoba membangkitkan proses MA paling sederhana, yaitu MA(2) dengan
$\theta 1 = 0.4$ dan $\theta 2 = 0.6$ sebanyak 300 observasi. Setelah
itu, diawali pembangkitan *white noise* terlebih dahulu.
...
Proses MA untuk MA(20$$
y_{t} = e_t + \theta_{1}e_{t-1} + \theta_{2}e_{t-2}
$$Untuk proses MA untuk MA (2) jika disubstitusikan parameternya,
seperti berikut

### Pembangkitan Proses MA(2) Nilai-nilai selanjutnya dapat dicari melalui loop. Bentuk loop dapat dilihat dari rumus MA(2) yang hendak dibangkitkan:
...
Deret waktu hasil simulasi MA(2) ini berfluktuasi acak di sekitar 0,
tidak memiliki tren, memiliki ketergantungan jangka pendek sampai lag
ke-2, dan varian relatif stabil sepanjang waktu. \### Plot ACF
...
Terlihat bahwa plot ACF terjadi cut off pada lag 2. \### Plot PACF
...
Terlihat bahwa plot PACF cenderung *tails off*.
...
Untuk baris p=0 (AR=0) terlihat pola untuk q= 0 dan 1 ada x, lalu mulai
q=2 muncul 0 beruntun. Hal tersebut menunjukkan bahwa jika kita tidak
memasukkan komponen AR (p=0), maka MA dengan q-2 adalah kandidat yang
baik, dengan q=2 ke kanan banyak nol sehingga membentuk pola segitiga
nol. Jika memungkinkan untuk memunculkan *zero triangle*, maka p=0 dan
q=2 adalah yang paling sederhana dan konsisten.
